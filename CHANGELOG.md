...
## [0.1.5](https://github.com/jondkinney/kanso/compare/v0.1.4...v0.1.5) - 2026-06-07

### Added

- *(scroll)* phase-aware scroll_view + rest-to-stop on macOS

## [0.1.4](https://github.com/jondkinney/kanso/compare/v0.1.3...v0.1.4) - 2026-06-04

### Fixed

- *(scroll)* make kinetic momentum + over-scroll trackpad-only

## [0.1.3](https://github.com/jondkinney/kanso/compare/v0.1.2...v0.1.3) - 2026-06-04

### Other

- fix over-scroll reversal, teleport + pos runaway
